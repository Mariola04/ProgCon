error id: file://<WORKSPACE>/server/src/main/scala/cp/serverPr/ServerState.scala:java/lang/Thread#
...
class ServerState(maxConcurrent: Int) {
  ...
  val inputLock = new Sema
  private val outputLock = new Object

  // === Processador da fila de entrada ===
  private val inputProcessor: T@@hread = new Thread(() => {
    while (true) {
