error id: file://<WORKSPACE>/server/src/main/scala/cp/serverPr/Routes.scala:cp/serverPr/ServerState#`<init>`().(maxConcurrent)
file://<WORKSPACE>/server/src/main/scala/cp/serverPr/Routes.scala
empty definition using pc, found symbol in pc: 
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/http4s/maxConcurrent.
	 -org/http4s/maxConcurrent#
	 -org/http4s/maxConcurrent().
	 -org/http4s/dsl/io/maxConcurrent.
	 -org/http4s/dsl/io/maxConcurrent#
	 -org/http4s/dsl/io/maxConcurrent().
	 -maxConcurrent.
	 -maxConcurrent#
	 -maxConcurrent().
	 -scala/Predef.maxConcurrent.
	 -scala/Predef.maxConcurrent#
	 -scala/Predef.maxConcurrent().
offset: 224
